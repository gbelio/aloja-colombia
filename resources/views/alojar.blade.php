...
<div class="container-fluid alojar">
    ...
    <div class="row">
        <div class="aloja-principal-pc col-md-12 text-center" style="background-image: url({{ asset('img/aloja-pc.jpg')}})">
            ...
            <div class="aloja-principal-pasos"><span>1</span> Registrate<br/><span>2</span> Carga los datos de tu alojamiento<br/><span>3</span> Empieza a ganar dinero.</div>
        ...
        <div class="col-md-10">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="aloja-personas-texto">“Desde que conocí Aloja Colombia y comencé a publicar mi propiedad solo tengo que dejar las llaves en portería y ellos se encargan de conseguirme el huésped y alquilarlo!<br/>¡Me encanta!”</div>
                </div>
                <div class="col-md-4">
                    <img class="aloja-personas-imagen" src="{{asset('img/andres.jpg')}}">
                    <div class="aloja-personas-nombre">Andrés F. Jaramillo</div>
                    <div class="aloja-personas-texto">“Aloja Colombia ha demostrado ser una plataforma 
amigable, cercana, de fácil acceso, publique mi Alojamiento y ahora tengo ingresos adicionales de una manera fácil, segura y lo mejor me transfieren directamente en mi cuenta bancaria de una manera segura!<br/>¡Se las recomiendo!”</div>
                </div>
                <div class="col-md-4">
                    <img class="aloja-personas-imagen" src="{{asset('img/juli.jpg')}}">
                    <div class="aloja-personas-nombre">Juliana Gómez</div>
                    <div class="aloja-personas-texto">“Recomiendo Aloja Colombia por la tranquilidad que me brinda al publicar mi propiedad y su gran respaldo y amabilidad hacia los propietarios. ¡Esto es lo que estaba buscando!<br/>Gracias Aloja Colombia.”</div>
                </div>
            </div>
        </div>
        <div class="col-md-1"></div>
