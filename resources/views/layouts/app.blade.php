...
<head>
    ...
    <link href="{{ asset('css/styles.css?57') }}" rel="stylesheet" type="text/css" >
...
@endif
    ...
    <div id="app">
    @endif
        @if ( Request::is('/') || Request::segment(2) == 'busqueda' || Request::segment(1) == 'alojar'  || $view_name == 'alojamientos.show')
        ...
        @endif
            <div class="container">
                ...
                @guest
                    <button class="navbar-toggler nav-imagen-generico" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                ...
                @else
                    ...
                    ?>
                    <button class="navbar-toggler nav-imagen-usuario" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}" style="background: none">
                        <span class="navbar-toggler-icon"></span>
                        @if ( $fotoUsuario == "")
                ...
                @if ( Request::is('/') || Request::segment(2) == 'busqueda' || Request::segment(1) == 'alojar' || $view_name == 'alojamientos.show' || app('request')->input('op') == 2)

                    @if ( app('request')->input('op') == 2 )
                    @else

                    <button class="btn boton_abrir_busqueda_menu" id="abrir-busqueda" onclick="window.scrollTo(0, 0);$('#panel-busqueda').toggle('slow'); $('#abrir-busqueda').toggle('slow'); $('#cerrar-busqueda').toggle('slow');" type="button"><i class="fa fa-search" aria-hidden="true"></i></button>
                ...
                @else
                    ...
                    @if ( !(Request::segment(1) == 'login' || Request::segment(1) == 'register' || Request::segment(1) == 'password') )
                        ...
                        <a class="boton-quiero-alojar btn boton-quiero-alojar-buscar-alojamiento" href="{{ url('/') }}">Busca alojamientos</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else                        
                            @if ( !(Request::is('/') || Request::segment(1) == 'alojar' || Request::segment(2) == 'busqueda' || Request::segment(1) == 'alojar' || $view_name == 'alojamientos.show' || (Request::segment(1) == 'alojamientosPedidos' && app('request')->input('op') == 2) ) )
                            <li class="nav-item">
                ...
                <div id="panel-busqueda">
                    ...
                    <div class="row" style="">
                            ...
                            <div class="col-xl-2">
                                ...
                                {!! Form::date('fd', app('request')->input('fd'), ['class' => 'form-control', 'min' => $fecha_actual, 'onchange' => 'setearFechaHastaDefault()' ]) !!}
                            </div>
                            <div class="col-xl-2">
                            ...
                            <div class="col-xl-2">
                                {!! Form::label('nada', '', [ 'style' => 'color: transparent' ] ) !!}
                                ...
                                <button class="btn boton_cerrar_busqueda_menu" type="button" style="display: none;" id="cerrar-busqueda" onclick="$('#panel-busqueda').toggle('slow'); $('#abrir-busqueda').toggle('slow'); $('#cerrar-busqueda').toggle('slow');"><i class="fa fa-close" aria-hidden="true"></i></button>
                            </div>
        ...
        <div class="row pie pie-pc">
            ...
            <div class="col-md-2">                
                <div style="max-width: fit-content; margin-right: auto; display: table; margin-left: auto;">
                    ...
                    <div><a class="pie-link text-center" href="mailto:hola@alojacolombia.com">hola@alojacolombia.com</a></div>
                    <br/>
                    <div class="text-center" style="padding-left: 10px;">
                        <div>
                            <a class="pie-red" href="https://www.facebook.com/alojaColombiaCom/" target="_blank"><img src="{{ url('/img/facebook.svg') }}"></a>
                            <a class="pie-red" href="https://www.instagram.com/aloja.colombia/" target="_blank"><img src="{{ url('/img/instagram.svg') }}"></a>
                            <a class="pie-red" href="https://api.whatsapp.com/send?phone=+573227704646&text=Bienvenidos%20a%20Aloja%20Colombia,%20env%C3%ADanos%20tu%20consulta%20y%20en%20breve%20nos%20contactaremos%20contigo." target="_blank"><img src="{{ url('/img/whatsapp.svg') }}"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 text-center">
                <div class="pie-pie">Copyright © {{date('Y')}} - Aloja Colombia - Todos los derechos reservados</div>
            </div>
        ...
        <div class="row pie pie-celu">
            ...
            <div class="col-6">
                ...
                <div><a class="pie-boton" href="{{ url('/') }}">Busco Alojamiento</a></div>
                <br/>
                <div><a style="float: left;" class="pie-red" href="https://www.facebook.com/alojaColombiaCom/" target="_blank"><img src="{{ url('/img/facebook.svg') }}"></a></div>
                <div><a style="float: left;" class="pie-red" href="https://www.instagram.com/aloja.colombia/" target="_blank"><img src="{{ url('/img/instagram.svg') }}"></a></div>
                <div><a class="pie-red" href="https://api.whatsapp.com/send?phone=+573227704646&text=Bienvenidos%20a%20Aloja%20Colombia,%20env%C3%ADanos%20tu%20consulta%20y%20en%20breve%20nos%20contactaremos%20contigo." target="_blank"><img src="{{ url('/img/whatsapp.svg') }}"></a></div>
            </div>
...
@if ( Request::is('/') || Request::segment(2) == 'busqueda' || Request::segment(1) == 'alojar'  || $view_name == 'alojamientos.show')
    ...
    function hasScrolled() {
        ...
        if (st > lastScrollTop && st > navbarHeight){
            // Scroll Down
            $('#panel-busqueda').hide('slow');
            $('#cerrar-busqueda').hide('slow');
            $('#abrir-busqueda').show('slow');        
        } 

        if ( st == 0 && $(window).width() > 767 ) {
            $('.home-page #panel-busqueda').show('slow');
            $('.home-page #abrir-busqueda').hide('slow');  
        }
