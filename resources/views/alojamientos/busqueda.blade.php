@extends('layouts.app')
 ...
 <div class="container-fluid busqueda">
  ...
  {!! Form::open(array('url' => 'alojamientos/busqueda', 'method' => 'GET', 'id' => 'filtros-busqueda', 'onsubmit' => 'return validarDatos();')) !!}
    ...
    {!! Form::tel('pd', str_replace('.', '', app('request')->input('pd')), [ 'id' => 'pd', 'placeholder' => 'Precio desde', 'class' => 'form-control' ]) !!}       


    {!! Form::tel('ph', str_replace('.', '', app('request')->input('ph')), [ 'id' => 'ph', 'placeholder' => 'Precio hasta', 'class' => 'form-control' ]) !!}
        ...
        <div class="card-body">
            ...
            <div class="busqueda-detalle-contenedor">
              ...
              <div class="busqueda-detalle">
                ...
                <div class="busqueda-detalle-descripcion">{{$alojamiento->tipoFormateado()}} - {{ $alojamiento->ciudad }}</div>
                <div class="busqueda-detalle-huespedes">{{$alojamiento->leyendaHuespedesCuartos()}}</div>
                <div class="busqueda-detalle-precio-titulo">Noche desde</div>
                <div class="busqueda-detalle-precio">$ {{$alojamiento->precioFormateado($alojamiento->precio_baja)}}</div>
                {!! link_to('alojamientos/' . $alojamiento->id . '?' . http_build_query(app('request')->query()) , 'Ver Alojamiento', ['style' => '', 'class' => ' btn busqueda-boton-ver']) !!}
              </div>              
            </div>
